// fe_port.c — FasterEdge MCU 平台移植层参考实现（CW32F003 / Cortex-M0+ 版）
...
//   time  : SysTick（内核定时器）
//   EEPROM: 无硬件，注释留 DataFlash 模拟参考（CW32F003 用户区 1KB）
...
// ============================================================
// EEPROM（CW32F003 无硬件 EEPROM；用用户区 DataFlash 模拟 1KB）
...
void fe_port_chip_info(char *out, u16 outlen) {
    fe_snprintf(out, outlen,
                "{\"chip\":\"CW32F003\",\"arch\":\"Cortex-M0+\","
                "\"ramBytes\":2048,\"flashBytes\":16384,\"eepromBytes\":1024,"
                "\"freqMHz\":48}");
}

// ============================================================
// 延时（软件循环，48MHz 约 1us/次）
// ============================================================
